...
- Files scanned: **9**
- Strings walked: **51,148**
- Strings containing markup: **4,561**
- Tag occurrences: **8,840**
...
| `{@spell}` | 1039 | 7 | 1 part ×325, 2 parts ×713, 3 parts ×1 | 0 | 0 |
| `{@item}` | 850 | 9 | 1 part ×50, 2 parts ×724, 3 parts ×76 | 0 | 0 |
| `{@condition}` | 727 | 7 | 1 part ×216, 2 parts ×510, 3 parts ×1 | 0 | 0 |
| `{@damage}` | 654 | 7 | 1 part ×654 | 0 | 0 |
| `{@dice}` | 547 | 8 | 1 part ×547 | 0 | 0 |
| `{@action}` | 469 | 7 | 1 part ×35, 2 parts ×421, 3 parts ×13 | 0 | 0 |
| `{@skill}` | 382 | 8 | 1 part ×120, 2 parts ×262 | 0 | 0 |
| `{@creature}` | 349 | 5 | 1 part ×73, 2 parts ×238, 3 parts ×38 | 0 | 0 |
| `{@dc}` | 296 | 6 | 1 part ×296 | 0 | 0 |
| `{@filter}` | 250 | 8 | 3 parts ×94, 4 parts ×134, 5 parts ×16, 6 parts ×3, 7 parts ×3 | 0 | 0 |
| `{@i}` | 202 | 6 | 1 part ×202 | 0 | 0 |
| `{@feat}` | 122 | 3 | 2 parts ×122 | 0 | 0 |
| `{@book}` | 84 | 7 | 2 parts ×26, 3 parts ×11, 4 parts ×47 | 0 | 0 |
| `{@sense}` | 83 | 7 | 1 part ×9, 2 parts ×74 | 0 | 0 |
| `{@scaledamage}` | 83 | 1 | 3 parts ×83 | 0 | 0 |
| `{@b}` | 82 | 2 | 1 part ×82 | 0 | 0 |
| `{@status}` | 72 | 6 | 1 part ×15, 2 parts ×50, 3 parts ×7 | 0 | 0 |
| `{@5etools}` | 63 | 1 | 2 parts ×63 | 0 | 0 |
| `{@table}` | 46 | 3 | 2 parts ×3, 3 parts ×43 | 0 | 0 |
| `{@deity}` | 41 | 1 | 1 part ×8, 2 parts ×27, 3 parts ×6 | 0 | 0 |
| `{@quickref}` | 35 | 5 | 3 parts ×19, 5 parts ×16 | 0 | 0 |
| `{@hit}` | 22 | 1 | 1 part ×22 | 0 | 0 |
| `{@chance}` | 21 | 2 | 1 part ×11, 5 parts ×10 | 0 | 0 |
...
| --- | ---: | ---: | --- |
| `entries` | 1414 | 7 | `entries` 1414, `name` 1358, `page` 2 |
| `item` | 407 | 6 | `name` 407, `entries` 221, `entry` 186 |
| `refSubclassFeature` | 272 | 1 | `subclassFeature` 272 |
| `list` | 241 | 8 | `items` 241, `style` 118, `columns` 1 |
